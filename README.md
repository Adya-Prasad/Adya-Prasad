...
`FRAMEWORKS:` Flask, Django, FastAPI, React js, Next js

`LIBRARY / MODULES:` PyTorch, TensorFlow, NLTK (NLP), PEFT, Transformers, Openai, Langchain, LlamaIndex, SQLAlchemy

`Platforms:` Linux, WordPress, Google Cloud, AWS,  Docker, Kubernetes</br>

`DB:` PostgreSQL, SQLite, MongoDB, Redis, ChromaDB </br>
...
"researcher" = {
    ...
    "focus"       : [
        ...
        "Large Multimodal Model Architectures",
